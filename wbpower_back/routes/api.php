...
Route::middleware('auth:api')->delete('/custom-post/delete/{tableName}/{id}', [CustomPostFormTableController::class, 'deleteCustomPost']);
Route::middleware('auth:api')->put('/custom-post/updatestatus/{tableName}/{id}', [CustomPostFormTableController::class, 'updateCustomPostStatus']);
